...
export const WORLDS: Record<WorldId, WorldConfig> = {
  ...
  ordlandet: {
    ...
    scenery: [
      ...
      { id: "o_tree_4", type: "tree", x: 700, y: 60, width: 50, height: 60 },
      { id: "o_tree_5", type: "tree", x: 80, y: 480, width: 50, height: 60 },
      { id: "o_tree_6", type: "tree", x: 300, y: 490, width: 50, height: 60 },
      { id: "o_tree_7", type: "tree", x: 520, y: 480, width: 50, height: 60 },
  ...
  ordhuset_interior: {
    id: "ordhuset_interior",
    name: "Ordhuset",
    subtitle: "Sagornas och bokstävernas hemliga sal",
    icon: "📖",
    width: 600,
    height: 500,
    spawnPosition: { x: 300, y: 410 },
    ...
    scenery: [
      ...
      },
      {
        ...
        width: 60,
        height: 95,
        label: "Rim och ramsor",
      },
      {
        id: "ord_station_pedestal_1",
        type: "pedestal",
        x: 105,
        y: 200,
        width: 90,
    ...
    interactables: [
      ...
      },
      {
        ...
        y: 255,
        radius: 65,
        label: "Nivå 2: Saknade bokstäver (Låst)",
        prompt: "Klara tidigare nivåer för att låsa upp denna!",
        action: "info",
        infoMessage: "Klara tidigare nivåer för att låsa upp denna! 🔒",
      },
      {
        id: "station_bygg_meningen",
        type: "building",
        x: 450,
        y: 255,
        radius: 65,
        label: "Nivå 3: Bygg meningen (Låst)",
        prompt: "Klara tidigare nivåer för att låsa upp denna!",
        action: "info",
        infoMessage: "Klara tidigare nivåer för att låsa upp denna! 🔒",
      },
